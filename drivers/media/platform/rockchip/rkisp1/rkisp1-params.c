...
rkisp1_isp_isr_other_config(struct rkisp1_params *params,
			    const struct rkisp1_params_buffer *buf)
{
	unsigned int module_en_update, module_cfg_update, module_ens;
	const struct rkisp1_params_cfg *new_params = buf->cfg;
...
void rkisp1_params_isr(struct rkisp1_device *rkisp1)
{
	...
	rkisp1_isp_isr_other_config(params, cur_buf);
	rkisp1_isp_isr_lsc_config(params, cur_buf);
	rkisp1_isp_isr_meas_config(params, cur_buf);
...
static int rkisp1_params_vb2_buf_init(struct vb2_buffer *vb)
{
	...
	params_buf->cfg = kvmalloc(sizeof(struct rkisp1_params_cfg),
				   GFP_KERNEL);
	if (!params_buf->cfg)
		return -ENOMEM;

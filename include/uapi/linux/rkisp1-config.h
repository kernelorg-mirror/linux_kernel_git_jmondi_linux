...
enum rkisp1_ext_params_block_group {
	RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS = (1 << 16),
	RKISP1_EXT_PARAMS_BLOCK_GROUP_LSC = (2 << 16),
	RKISP1_EXT_PARAMS_BLOCK_GROUP_MEAS = (4 << 16),
};

enum rkisp1_ext_params_block_id {
	RKISP1_EXT_PARAMS_BLOCK_ID_BLS,
	RKISP1_EXT_PARAMS_BLOCK_ID_DPCC,
	RKISP1_EXT_PARAMS_BLOCK_ID_SDG,
	RKISP1_EXT_PARAMS_BLOCK_ID_AWB_GAINS,
	RKISP1_EXT_PARAMS_BLOCK_ID_FLT,
	RKISP1_EXT_PARAMS_BLOCK_ID_BDM,
	RKISP1_EXT_PARAMS_BLOCK_ID_CTK,
	RKISP1_EXT_PARAMS_BLOCK_ID_GOC,
	RKISP1_EXT_PARAMS_BLOCK_ID_DPF,
	RKISP1_EXT_PARAMS_BLOCK_ID_DPF_STRENGHT,
	RKISP1_EXT_PARAMS_BLOCK_ID_CPROC,
	RKISP1_EXT_PARAMS_BLOCK_ID_IE,
	RKISP1_EXT_PARAMS_BLOCK_ID_LSC,
	RKISP1_EXT_PARAMS_BLOCK_ID_AWB_MEAS,
	RKISP1_EXT_PARAMS_BLOCK_ID_HST_MEAS,
	RKISP1_EXT_PARAMS_BLOCK_ID_AEC_MEAS,
	RKISP1_EXT_PARAMS_BLOCK_ID_AFC_MEAS,
	RKISP1_EXT_PARAMS_BLOCK_ID_SENTINEL,
};
...
enum rkisp1_ext_params_block_type {
	/* "Other" block group types. */
	RKISP1_EXT_PARAMS_BLOCK_TYPE_BLS = RKISP1_EXT_PARAMS_BLOCK_ID_BLS |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_DPCC =
		RKISP1_EXT_PARAMS_BLOCK_ID_DPCC |
		RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_SDG = RKISP1_EXT_PARAMS_BLOCK_ID_SDG |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_AWB_GAINS =
		RKISP1_EXT_PARAMS_BLOCK_ID_AWB_GAINS |
		RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_FLT = RKISP1_EXT_PARAMS_BLOCK_ID_FLT |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_BDM = RKISP1_EXT_PARAMS_BLOCK_ID_BDM |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_CTK = RKISP1_EXT_PARAMS_BLOCK_ID_CTK |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_GOC = RKISP1_EXT_PARAMS_BLOCK_ID_GOC |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_DPF = RKISP1_EXT_PARAMS_BLOCK_ID_DPF |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	...
	RKISP1_EXT_PARAMS_BLOCK_TYPE_CPROC =
		RKISP1_EXT_PARAMS_BLOCK_ID_CPROC |
		RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,
	RKISP1_EXT_PARAMS_BLOCK_TYPE_IE = RKISP1_EXT_PARAMS_BLOCK_ID_IE |
					  RKISP1_EXT_PARAMS_BLOCK_GROUP_OTHERS,

	/* "LSC" block group types. */
	RKISP1_EXT_PARAMS_BLOCK_TYPE_LSC = RKISP1_EXT_PARAMS_BLOCK_ID_LSC |
					   RKISP1_EXT_PARAMS_BLOCK_GROUP_LSC,

	/* "Meas" block group types. */
